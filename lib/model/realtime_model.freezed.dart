...
class _$_Realtime implements _Realtime {
  ...
  @override
  String toString() {
    return 'Realtime(subwayId: $subwayId, subwayNm: $subwayNm, updnLine: $updnLine, trainLineNm: $trainLineNm, subwayHeading: $subwayHeading, statnFid: $statnFid, statnTid: $statnTid, statnId: $statnId, statnNm: $statnNm, subwayList: $subwayList, btrainSttus: $btrainSttus, btrainNo: $btrainNo, bstatnId: $bstatnId, bstatnNm: $bstatnNm, arvlMsg2: $arvlMsg2, arvlMsg3: $arvlMsg3, arvlCd: $arvlCd)';
  }
...
abstract class _Realtime implements Realtime {
  const factory _Realtime(
      ...
      final String? arvlMsg2,
      final String? arvlMsg3,
      final String? arvlCd}) = _$_Realtime;
